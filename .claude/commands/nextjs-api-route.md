---
description: Creating, reviewing, refactoring, or debugging internal API routes in this Next.js 16.2.9 project under the required /api folder with strict TypeScript contracts.
---
