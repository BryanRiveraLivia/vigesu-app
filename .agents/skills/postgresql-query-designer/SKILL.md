---
name: postgresql-query-designer
description: Use this skill when writing SQL, designing relational tables, handling transactions, or avoiding SQL injections for PostgreSQL databases.
---
